      ...
      <section className="py-20 gradient-mesh-hero">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Hardware Supply</h1>
            <p className="text-lg text-text-secondary mb-8">Quality IT Hardware & Equipment</p>
            <Button asChild size="lg">
              <Link href="/contact-us">Request Quote <ArrowRight className="w-5 h-5" /></Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto glass-card p-8">
            <p className="text-lg text-text-secondary leading-relaxed">
              Supply of quality IT hardware including servers, computers, POS terminals, printers, and networking equipment from leading brands.
            </p>
          </div>
        </div>
      </section>
